...
class BDD100K(Dataset):
    ...
    def create_index(self):
        ...
        listfile = "splits/bdd100k_highway/test_lanes_culane-eval.txt"
        ...
        with open(listfile) as f:
            for line in f:
                l = line.strip()
                self.img_list.append(os.path.join(self.data_dir_path, l))  # l[1:]  get rid of the first '/' so as for os.path.join
