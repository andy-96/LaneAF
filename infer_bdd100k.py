...
from datasets.bdd100k import BDD100K, get_lanes_culane
...
test_loader = DataLoader(BDD100K(args.dataset_dir, 'test', False), **kwargs)

# create file handles
f_log = open(os.path.join(args.output_dir, "logs.txt"), "w")

# get test set filenames
with open("splits/bdd100k_highway/test_lanes_culane-eval.txt", "r") as f:
